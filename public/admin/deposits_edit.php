<?php
// public/admin/deposits_edit.php
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['save_deposit'])) {
    ...
    $message = $admin->update_saving_deposit($deposit_id, $amount, $deposit_type, $status, $period_months);
...
$row  = null;
$data = $admin->read_all_saving_deposit();
