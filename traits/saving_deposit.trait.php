...
trait saving_deposit
{
    ...
    public function create_saving_deposit($card_num, $account_id, $amount, $currency, $deposit_type, $period_months)
    {
        global $pdo; 
    ...
    public function read_customer_saving_deposit($accont_id)
    {
        global $pdo;

        try
        {
            $sql = "SELECT deposit_id, amount, currency, deposit_type, interest_rate, status,
    ...
    public function search_saving_deposit($search)
    {
        ...
        try
        {
            $sql = "SELECT * FROM deposit
                    WHERE deposit_id LIKE :search OR currency LIKE :search
                    OR deposit_type LIKE :search OR start_date LIKE :search
